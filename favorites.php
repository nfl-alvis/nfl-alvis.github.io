...
$user = current_user();
$products = $user ? find_favorite_products((int) $user['id']) : [];
  ...
  <section class="fav-hero">
    <div class="fav-hero-inner">
      <div>
        ...
        <h1>Makanan Favorit Anda</h1>
        <p>Temukan kembali makanan yang sudah Anda tandai sebagai favorit dan buka detail produknya dengan mudah.</p>
      </div>
