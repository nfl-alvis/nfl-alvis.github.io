    ...
    <div class="shell">
      <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
          ...
          <a href="<?= e(base_path('admin-product-edit.php?id=' . $product['id'])) ?>" class="nav-link active">
            <span class="nav-link-icon">✏️</span> Edit Produk
          </a>
      ...
      <main class="main">
        <div class="topbar">
          <div>
            <div class="topbar-heading">Edit Produk</div>
            <div class="topbar-sub">Perbarui detail produk, gambar, dan status publikasinya.</div>
          </div>
